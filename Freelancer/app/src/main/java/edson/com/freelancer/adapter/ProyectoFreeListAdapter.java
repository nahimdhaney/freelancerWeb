...
public class ProyectoFreeListAdapter extends BaseAdapter {

    private List<Proyectos> items;
    private Context context;

    public ProyectoFreeListAdapter(Context context, List<Proyectos> items) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if(view == null){
            view = LayoutInflater.from(context).inflate(R.layout.layou_list_proyectofrecon, viewGroup, false);
        }
